...
def worker_loop(worker_id: int, mangaba_home: str, result_file: str) -> None:
...
def reclaimer_loop(mangaba_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="mangaba_mixed_stress_")
    print(f"MANGABA_HOME = {home}")
