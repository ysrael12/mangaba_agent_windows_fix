"""Tests for CodexEventProjector — codex item/* events → Mangaba messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Mangaba' message alternation invariant."""
