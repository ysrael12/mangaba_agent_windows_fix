...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("mangaba_cli.config.get_config_path", return_value=config_path), \
             patch("mangaba_cli.config.ensure_mangaba_home"):
    ...
    def test_ensure_mangaba_home_sets_0700(self):
        home = Path(self.tmpdir) / ".mangaba"
        with patch("mangaba_cli.config.get_mangaba_home", return_value=home):
