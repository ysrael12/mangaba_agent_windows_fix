...
from mangaba_agent.trajectory_compressor import (
    CompressionConfig,
    TrajectoryMetrics,
    AggregateMetrics,
...
def test_import_loads_env_from_mangaba_home(tmp_path, monkeypatch):
    home = tmp_path / ".mangaba"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-mangaba-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-mangaba-home"
