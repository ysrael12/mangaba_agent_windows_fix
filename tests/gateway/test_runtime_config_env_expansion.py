...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("MANGABA_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("MANGABA_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("MANGABA_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
