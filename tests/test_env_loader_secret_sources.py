"""Tests for the secret-source tracking in ``mangaba_cli.env_loader``.

These cover the small public surface that lets `mangaba model` / `mangaba setup`
...
from mangaba_cli import env_loader  # noqa: E402
