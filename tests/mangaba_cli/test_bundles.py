"""Tests for mangaba_cli/bundles.py — the `mangaba bundles` CLI subcommand."""
...
from mangaba_cli.bundles import (
    bundles_command,
    register_cli,
)
...
def bundles_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("MANGABA_BUNDLES_DIR", str(bundles_dir))
