...
The notice prints the most recent curator run summary on `mangaba update`,
...
session start) so users normally never see the rename map. `mangaba update`
