"""Tests for the interactive session browser (`mangaba sessions browse`).
...
from mangaba_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """mangaba sessions browse should be parseable."""
        from mangaba_cli.main import main as _main_entry
