...
The main() function in mangaba_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `mangaba -c model`
...
def _build_parser():
    """Build a minimal replica of the mangaba top-level parser."""
