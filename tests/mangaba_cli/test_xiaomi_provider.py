...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from mangaba_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in MANGABA_OVERLAYS
        overlay = MANGABA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify mangaba doctor recognizes Xiaomi env vars."""
