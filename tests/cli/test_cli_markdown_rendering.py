...
from mangaba_agent.cli import _render_final_assistant_content
...
def test_final_assistant_content_preserves_windows_hidden_dir_paths():
    renderable = _render_final_assistant_content(
        r"D:\Projects\SourceCode\mangaba-agent\.ai\skills" + "\\"
    )

    output = _render_to_text(renderable)
    assert r"D:\Projects\SourceCode\mangaba-agent\.ai\skills" + "\\" in output
