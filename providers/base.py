...
def _profile_user_agent() -> str:
    """Return a ``mangaba-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from mangaba_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"mangaba-cli/{_ver}"
    except Exception:
        return "mangaba-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # mangaba-cli UA so the catalog endpoint is reachable.
