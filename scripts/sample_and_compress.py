...
DEFAULT_DATASETS = [
    "dheiver2/swe-terminus-agent-glm-kimi-minimax",
    "dheiver2/mangaba-agent-megascience-sft1",
    "dheiver2/Mangaba-Agent-Thinking-GLM-4.7-SFT2",
    "dheiver2/Mangaba-Agent-Thinking-GLM-4.7-SFT1",
    "dheiver2/terminal-tasks-glm-mangaba-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "dheiver2/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload dheiver2/{output_name} {final_output}")
