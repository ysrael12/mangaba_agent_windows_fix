#!/usr/bin/env python3
"""Build the Mangaba Model Catalog — a centralized JSON manifest of curated models.
...
Mangaba CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Mangaba release.
...
# Ensure MANGABA_HOME is set for imports that touch it at module level.
os.environ.setdefault("MANGABA_HOME", os.path.join(os.path.expanduser("~"), ".mangaba"))

from mangaba_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "mangaba-agent repo",
            "docs": "https://dheiver2.github.io/mangaba-agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
