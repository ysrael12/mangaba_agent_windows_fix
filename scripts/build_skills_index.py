#!/usr/bin/env python3
"""Build the Mangaba Skills Index — a centralized JSON catalog of all skills.
...
`mangaba skills search/install` can use it without hitting the GitHub API.
...
# Ensure MANGABA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Mangaba Skills Index...", flush=True)
