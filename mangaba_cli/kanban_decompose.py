...
Invoked by ``mangaba kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``mangaba_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Mangaba Agent board.
...
def _profile_author() -> str:
    """Mirror of ``mangaba_cli.kanban._profile_author``."""
    return (
