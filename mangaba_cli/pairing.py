...
Usage:
    mangaba pairing list              # Show all pending + approved users
    mangaba pairing approve <platform> <code>  # Approve a pairing code
    mangaba pairing revoke <platform> <user_id> # Revoke user access
    mangaba pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle mangaba pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: mangaba pairing {list|approve|revoke|clear-pending}")
        print("Run 'mangaba pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.mangaba/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'mangaba pairing list' to see pending codes.\n")
