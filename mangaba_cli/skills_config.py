"""
Skills configuration for Mangaba Agent.
`mangaba skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.mangaba/config.yaml under:
...
from mangaba_cli.config import cfg_get, load_config, save_config
from mangaba_cli.colors import Colors, color
from mangaba_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `mangaba skills`."""
    from mangaba_cli.curses_ui import curses_checklist
