...
Used by ``mangaba profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the Mangaba Agent kanban board.
...
Rules:
  ...
  - Never write "Mangaba Agent profile" or other meta-narration.
