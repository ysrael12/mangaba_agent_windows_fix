...
Built for [Mangaba Agent](https://github.com/dheiver2/mangaba-agent). Usable in any coding agent. Canonical source lives here; synced to [`dheiver2/mangaba-agent/skills/creative/ascii-video`](https://github.com/dheiver2/mangaba-agent/tree/main/skills/creative/ascii-video) via PR.
