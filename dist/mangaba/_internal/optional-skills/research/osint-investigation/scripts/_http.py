...
DEFAULT_UA = (
    "mangaba-osint-investigation/0.2 "
    "(+https://github.com/dheiver2/mangaba-agent; "
    "set MANGABA_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("MANGABA_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
