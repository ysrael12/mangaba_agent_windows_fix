...
Data file: $MANGABA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_MANGABA_HOME = Path(os.environ.get("MANGABA_HOME", Path.home() / ".mangaba"))
DATA_DIR = _MANGABA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
