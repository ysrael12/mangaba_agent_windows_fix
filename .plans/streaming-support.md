# Streaming LLM Response Support for Mangaba Agent
...
```
MANGABA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("MANGABA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `mangaba_cli/config.py` | 1 | +streaming config defaults |
...
MANGABA_STREAMING_ENABLED=true
```
