...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - mangaba_home (str): The active MANGABA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.mangaba``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "mangaba").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'mangaba memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], mangaba_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'mangaba memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``mangaba_home`` is the active MANGABA_HOME directory path.
