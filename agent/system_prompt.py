...
upstream prefix cache warm.  See ``mangaba-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Mangaba never re-renders parts of this string mid-
    ...
    # Some execution modes (cron) still want MANGABA_HOME persona while keeping
    ...
    # MANGABA_KANBAN_TASK env var). Normal chat sessions never see
    ...
    if not agent.skip_context_files:
        ...
        # mode).  The gateway process runs from the mangaba-agent install
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Mangaba never rebuilds or reinjects parts of it
