...
from mangaba_agent.utils import base_url_host_matches, base_url_hostname, env_var_enabled, atomic_json_write
...
def try_recover_primary_transport(
    ...
    if provider_lower in {"nous", "dheiver2"}:
        return False
...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        if env_var_enabled("MANGABA_DUMP_REQUEST_STDOUT"):
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    is_nous_portal = "dheiver2" in eff_base_url.lower()
...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    if hasattr(agent, "context_compressor") and agent.context_compressor:
        ...
        try:
            from mangaba_cli.config import load_config, get_compatible_custom_providers
            _sm_cfg = load_config()
