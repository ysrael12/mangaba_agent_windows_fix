...
projection into Mangaba' display, approval bridging, transcript projection into
...
"codex_app_server"`. Mangaba' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("MANGABA_KANBAN_TASK"):
            kanban_db = spawn_env.get("MANGABA_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "MANGABA_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("MANGABA_HOME", os.path.expanduser("~/.mangaba")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "mangaba",
        client_title: str = "Mangaba Agent",
