...
Trust levels:
  - builtin:   Ships with Mangaba. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.mangaba/\.env|\~/\.mangaba/\.env',
     "mangaba_env_access", "critical", "exfiltration",
     "directly references Mangaba secrets file"),
    ...
    (r'\.mangaba/config\.yaml|\.mangaba/SOUL\.md',
     "mangaba_config_mod", "critical", "persistence",
     "references Mangaba configuration files directly"),
