...
the get_anchored_view / get_messages_around primitives in mangaba_state.
...
# Third-party integrations tag their sessions with MANGABA_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from mangaba_agent.mangaba_state import DEFAULT_DB_PATH
