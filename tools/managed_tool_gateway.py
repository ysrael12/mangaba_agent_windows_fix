...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "dheiver2.com"
...
def auth_json_path():
    """Return the Mangaba auth store path, respecting MANGABA_HOME overrides."""
    return get_mangaba_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from mangaba_cli.auth import resolve_nous_access_token
