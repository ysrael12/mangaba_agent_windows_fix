...
``_check_spotify_available()`` — when the user has not run ``mangaba auth
spotify``, the tools remain registered (so they appear in ``mangaba
...
The Spotify auth flow (``mangaba auth spotify``), CLI plumbing, and docs
