# Mangaba Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.mangaba/plugins/mangaba-achievements/state.json` (existing unlock state)
  - `~/.mangaba/plugins/mangaba-achievements/scan_snapshot.json` (new)
  - `~/.mangaba/plugins/mangaba-achievements/scan_checkpoint.json` (new)
