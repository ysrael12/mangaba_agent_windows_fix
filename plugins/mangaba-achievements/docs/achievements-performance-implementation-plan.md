# Mangaba Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.mangaba/plugins/mangaba-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.mangaba/plugins/mangaba-achievements/scan_checkpoint.json`.
