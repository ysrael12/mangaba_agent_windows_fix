# Mangaba Agent Has Had "Routines" Since March
...
Mangaba equivalent — works today:
```bash
...
Mangaba equivalent — works today:
```bash
mangaba webhook subscribe auth-watch \
  --events "pull_request" \
...
Every use case in their blog post — backlog triage, docs drift, deploy verification, alert correlation, library porting, bespoke PR review — has a working Mangaba implementation. No new features needed. It's been shipping since March 2026.

---

## What's Different

| | Claude Code Routines | Mangaba Agent |
|---|---|---|
...
## Things Mangaba Does That Routines Can't
...
Mangaba has no daily limit. Run 500 automations a day if you want. The only constraint is your API budget, and you choose which models to use for which tasks.
...
Mangaba Agent is open source and free. The automation infrastructure — cron scheduler, webhook platform, skill system, multi-platform delivery — is built in.
...
```bash
mangaba gateway setup    # enable webhooks
mangaba webhook subscribe pr-review \
  --events "pull_request" \
...
Full automation templates gallery: [dheiver2.github.io/mangaba-agent/docs/guides/automation-templates](https://dheiver2.github.io/mangaba-agent/docs/guides/automation-templates)

Documentation: [dheiver2.github.io/mangaba-agent](https://dheiver2.github.io/mangaba-agent)

GitHub: [github.com/dheiver2/mangaba-agent](https://github.com/dheiver2/mangaba-agent)

---

*Mangaba Agent is built by [Dheiver Santos](https://dheiver2.com). Open source, model-agnostic, runs on your infrastructure.*
