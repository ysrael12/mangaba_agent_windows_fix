#!/usr/bin/env python3
"""
SWE Runner with Mangaba Trajectory Format

A runner that uses Mangaba-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Mangaba-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Mangaba-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Mangaba format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Mangaba-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Mangaba-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Mangaba Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Mangaba-Agent's built-in execution environments
    and outputs trajectories in Mangaba-Agent format.
    """
    ...
    def _convert_to_mangaba_format(
        self,
        ...
        """
        Convert internal message format to Mangaba trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Mangaba trajectory format
        trajectory = self._convert_to_mangaba_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Mangaba trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Mangaba Trajectory Format")
    print("=" * 60)
