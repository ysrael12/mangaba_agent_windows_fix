"""Windows UTF-8 bootstrap for Mangaba entry points.
...
should be imported at the very top of every Mangaba entry point
(``mangaba``, ``mangaba-agent``, ``mangaba-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import mangaba_bootstrap``
# (or ``from mangaba_bootstrap import apply_windows_utf8_bootstrap``) at
