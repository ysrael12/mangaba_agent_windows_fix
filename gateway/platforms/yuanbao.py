...
try:
    ...
    _MANGABA_VERSION = "0.0.0"

_APP_VERSION = _MANGABA_VERSION
_BOT_VERSION = _MANGABA_VERSION
_YUANBAO_INSTANCE_ID = str(MANGABA_INSTANCE_ID)  # single source: yuanbao_proto.MANGABA_INSTANCE_ID
