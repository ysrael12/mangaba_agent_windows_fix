...
Config: ~/.mangaba/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.mangaba/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_mangaba_home()`` helper (MANGABA_HOME-aware and
...
RULES_FILE = get_mangaba_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_mangaba_home() / "feishu_comment_pairing.json"
