...
import type { ScrollBoxHandle } from '@mangaba/ink'
import { evictInkCaches } from '@mangaba/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.MANGABA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
