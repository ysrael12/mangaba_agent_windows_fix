 ...
 *
 * Symptom: in `mangaba --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@mangaba/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using mangaba --tui and as i type multiline my caret at the end will often ' +
