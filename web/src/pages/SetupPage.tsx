...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: "Mande uma mensagem ao funcionário agêntico e veja a resposta em tempo real.",
  ...
  },
  {
    ...
    description: "Diga ao funcionário agêntico o que lembrar sobre você e seu contexto.",
