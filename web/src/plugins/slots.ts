 ...
 * `window.__MANGABA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Mangaba brand in the top bar
 ...
 *  `window.__MANGABA_PLUGINS__.registerSlot(...)`.
 *
