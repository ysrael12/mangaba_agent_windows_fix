 ...
 *
 * Plugins call window.__MANGABA_PLUGINS__.register(name, Component)
...
import { Tabs, TabsList, TabsTrigger } from "@dheiver2/ui/ui/components/tabs";
...
declare global {
  interface Window {
    __MANGABA_PLUGIN_SDK__: unknown;
    __MANGABA_PLUGINS__: {
...
export function exposePluginSDK() {
  window.__MANGABA_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__MANGABA_PLUGIN_SDK__ = {
