...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateMangaba: "Mangaba'i Güncelle",
    updatingMangaba: "Mangaba güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Mangaba eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`mangaba plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.mangaba/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.mangaba/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.mangaba/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Mangaba rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Mangaba oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Mangaba'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Mangaba ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Mangaba yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
