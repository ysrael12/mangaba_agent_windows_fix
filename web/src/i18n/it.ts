...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateMangaba: "Aggiorna Mangaba",
    updatingMangaba: "Aggiornamento di Mangaba…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Mangaba (parità con `mangaba plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.mangaba/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.mangaba/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.mangaba/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Mangaba da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Mangaba in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Mangaba di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Mangaba rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Mangaba sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
