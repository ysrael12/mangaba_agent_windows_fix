...
export const pt: Translations = {
  ...
  status: {
    ...
    updatingMangaba: "A atualizar Mangaba…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Mangaba (paridade com `mangaba plugins`).",
    ...
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.mangaba/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.mangaba/skills/",
  ...
  achievements: {
    hero: {
      ...
      scan_subtitle:
        "A analisar o histórico de sessões do Mangaba. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Mangaba",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Mangaba detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Mangaba analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
