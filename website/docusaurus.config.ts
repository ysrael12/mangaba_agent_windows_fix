...
const config: Config = {
  ...
  url: 'https://dheiver2.github.io/mangaba-agent',
  baseUrl: '/docs/',

  organizationName: 'dheiver2',
  projectName: 'mangaba-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/dheiver2/mangaba-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/mangaba-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://dheiver2.github.io/mangaba-agent',
          label: 'Home',
          position: 'right',
        },
        {
          href: 'https://github.com/dheiver2/mangaba-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/dheiver2',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/dheiver2' },
            { label: 'GitHub Discussions', href: 'https://github.com/dheiver2/mangaba-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/dheiver2/mangaba-agent' },
            { label: 'Dheiver Santos', href: 'https://dheiver2.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://dheiver2.com">Dheiver Santos</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
