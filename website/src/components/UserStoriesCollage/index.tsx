  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Mangaba Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Mangaba &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Mangaba?{' '}
        <a
          href="https://github.com/dheiver2/mangaba-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/dheiver2" target="_blank" rel="noopener noreferrer">
          Dheiver Santos Discord
        </a>{' '}
