#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Mangaba docs site.
...
Both publish at:
  https://dheiver2.github.io/mangaba-agent/docs/llms.txt
  https://dheiver2.github.io/mangaba-agent/docs/llms-full.txt
...
SITE_BASE = "https://dheiver2.github.io/mangaba-agent/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Mangaba as a Python Library", None),
        ("guides/use-mcp-with-mangaba", "Use MCP with Mangaba", None),
        ("guides/use-voice-mode-with-mangaba", "Use Voice Mode with Mangaba", None),
        ("guides/use-soul-with-mangaba", "Use SOUL.md with Mangaba", None),
        ("guides/build-a-mangaba-plugin", "Build a Mangaba Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Mangaba"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Mangaba Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Dheiver Santos. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/dheiver2/"
        "mangaba-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/dheiver2/mangaba-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Mangaba Agent — Full Documentation\n",
        (
            "This file is the entire Mangaba Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Mangaba, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://dheiver2.github.io/mangaba-agent/docs\n",
        "Short index: https://dheiver2.github.io/mangaba-agent/docs/llms.txt\n",
        "\n---\n\n",
    ]
