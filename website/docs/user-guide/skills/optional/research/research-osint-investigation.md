...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Mangaba Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $MANGABA_OSINT_CACHE/icij/ (default: ~/.cache/mangaba-osint/icij/).
...
# Set MANGABA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
