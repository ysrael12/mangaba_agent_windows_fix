...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/research/qmd` |
...
Mangaba Agent via the native MCP client. This is the preferred
...
Then configure Mangaba Agent to connect via HTTP:
