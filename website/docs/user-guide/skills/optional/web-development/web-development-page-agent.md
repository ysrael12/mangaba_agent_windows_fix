...
- User wants **Mangaba itself to drive a browser** → use Mangaba' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
