...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Mangaba Agent |
| License | MIT |
...
```
SCRIPT=~/.mangaba/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.mangaba/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
