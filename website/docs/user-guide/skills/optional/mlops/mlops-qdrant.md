...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/dheiver2/mangaba-agent/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/dheiver2/mangaba-agent/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
