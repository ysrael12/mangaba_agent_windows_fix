...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/mlops/peft` |
...
- **[Advanced Usage](https://github.com/dheiver2/mangaba-agent/blob/main/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/dheiver2/mangaba-agent/blob/main/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
