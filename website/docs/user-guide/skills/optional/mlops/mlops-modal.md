...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/dheiver2/mangaba-agent/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/dheiver2/mangaba-agent/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
