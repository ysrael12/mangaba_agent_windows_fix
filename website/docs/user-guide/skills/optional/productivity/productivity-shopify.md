...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Mangaba","productType":"Apparel","tags":["test"]}}'
```
