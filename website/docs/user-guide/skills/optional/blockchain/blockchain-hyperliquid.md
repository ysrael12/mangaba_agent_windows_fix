...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Mangaba Agent |
| License | MIT |
...
The script reads `~/.mangaba/.env` for two optional defaults:
...
Helper script: `~/.mangaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.mangaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.mangaba/.env`.
...
```bash
python3 ~/.mangaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.mangaba/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
