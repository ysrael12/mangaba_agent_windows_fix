...
| | |
|---|---|
| Source | Optional — install with `mangaba skills install official/health/neuroskill-bci` |
...
Connect Mangaba to a running [NeuroSkill](https://neuroskill.com/) instance to read
