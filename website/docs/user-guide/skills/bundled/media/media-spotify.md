...
Control the user's Spotify account via the Mangaba Spotify toolset (7 tools). Setup guide: https://dheiver2.github.io/mangaba-agent/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `mangaba auth spotify` again.
