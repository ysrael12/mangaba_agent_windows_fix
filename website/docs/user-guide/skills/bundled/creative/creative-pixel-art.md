...
```python
import sys
sys.path.insert(0, "/home/teknium/.mangaba/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.mangaba/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Mangaba installs package this)
