...
```bash
python3 -m pyfiglet "MANGABA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=MANGABA&font=Slant" | boxes -d stone
```
