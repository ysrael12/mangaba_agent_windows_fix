...
| [`mangaba-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-mangaba-agent) | Configure, extend, or contribute to Mangaba Agent. | `autonomous-ai-agents/mangaba-agent` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via Mangaba CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-mangaba-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-mangaba-tui-commands) | Debug Mangaba TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-mangaba-tui-commands` |
| [`mangaba-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-mangaba-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/mangaba-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .mangaba/plans/, no exec. | `software-development/plan` |
