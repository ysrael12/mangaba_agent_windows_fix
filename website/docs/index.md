...
slug: /
sidebar_position: 0
title: "Mangaba Agent Documentation"
description: "The self-improving AI agent built by Dheiver Santos. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Dheiver Santos](https://dheiver2.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/dheiver2/mangaba-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Mangaba safely |
| 🧭 **[Use MCP with Mangaba](/docs/guides/use-mcp-with-mangaba)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Mangaba](/docs/guides/use-voice-mode-with-mangaba)** | Hands-on setup and usage patterns for Mangaba voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Mangaba' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Mangaba |
...
- **Built by model trainers** — Created by [Dheiver Santos](https://dheiver2.com), the lab behind Mangaba, Nomos, and Psyche. Works with [Nous Portal](https://portal.dheiver2.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Dheiver Santos](https://dheiver2.com) — the lab behind Mangaba, Nomos, and Psyche models
